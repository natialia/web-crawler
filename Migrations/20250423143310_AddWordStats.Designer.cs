...
namespace WebCrawler.Migrations
{
    ...
    [Migration("20250423143310_AddWordStats")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WebCrawler.Models.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("WebCrawler.Models.PdfDocument", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("WebCrawler.Models.WordStat", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("WebCrawler.Models.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("WebCrawler.Models.SearchHistory", b =>
                {
                    b.HasOne("WebCrawler.Models.ApplicationUser", "User")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("WebCrawler.Models.WordStat", b =>
                {
                    b.HasOne("WebCrawler.Models.PdfDocument", "PdfDocument")
                        .WithMany("WordStats")
